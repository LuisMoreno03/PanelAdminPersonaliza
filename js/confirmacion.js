...
function renderEstadoPill(estado) {
  ...
  if (s.includes("por preparar")) return `<span class="${base} bg-slate-900 border-slate-700 text-white"><span class="h-2 w-2 rounded-full bg-slate-300"></span>⏳ Por preparar</span>`;
  if (s.includes("confirmado")) return `<span class="${base} bg-fuchsia-600 border-fuchsia-700 text-white"><span class="h-2 w-2 rounded-full bg-white"></span>✅ Confirmado</span>`;
