...
<div id="modalDetallesFull" class="hidden fixed inset-0 z-[9999] bg-black/50 backdrop-blur-sm">
  <div class="h-full w-full bg-white flex flex-col">
    ...
    <div class="flex-1 overflow-auto">
      <div class="max-w-[1500px] mx-auto px-5 sm:px-8 py-6 grid grid-cols-1 xl:grid-cols-3 gap-4">
        ...
        <div class="xl:col-span-2 space-y-4">
          ...
          <div class="rounded-3xl border border-slate-200 bg-white shadow-sm overflow-hidden">
            <div class="px-5 py-4 border-b border-slate-200 flex items-center justify-between">
              ...
              <span id="detItemsCount" class="text-xs font-extrabold px-3 py-1 rounded-full bg-slate-50 border border-slate-200 text-slate-700">0</span>
            </div>
          ...
          <div class="rounded-3xl border border-slate-200 bg-white shadow-sm">
            <div class="px-5 py-4 border-b border-slate-200">
              ...
              <p class="text-sm text-slate-500 mt-1">Estado, tags, pago, envío, notas.</p>
            </div>
