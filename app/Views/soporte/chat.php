...
<head>
  ...
  <!-- Si tu panel YA carga Alpine, comenta esta línea para evitar doble Alpine -->
...
<body class="min-h-screen bg-slate-100">
              ...
              <div class="flex items-center gap-3 min-w-0">
                ...
                <div class="min-w-0">
                  ...
                  <div class="text-xs text-slate-600 truncate" x-show="ticket">
                    <span class="font-semibold" x-text="statusLabel(ticket ? ticket.status : '')"></span>
  ...
  <!-- ✅ cache-buster para que SIEMPRE cargue el nuevo JS -->
