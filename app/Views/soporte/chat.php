...
<head>
  ...
  <!-- Emoji picker (ligero) -->
  <script defer src="https://cdn.jsdelivr.net/npm/@joeattardi/emoji-button@4.6.4/dist/index.min.js"></script>
        ...
        <script>
          window.SUPPORT = {
            ...
            endpoints: {
              ...
              whoami: "<?= base_url('soporte/whoami') ?>"
            }
          };
        </script>
            ...
            <div class="p-4 border-b border-slate-200 flex items-center justify-between">
              <div class="flex items-center gap-3 min-w-0">
                ...
                <div class="min-w-0">
                  ...
                  <div class="text-[11px] text-slate-400 truncate" x-text="`Rol detectado: ${role || '-'}`"></div>
                </div>
              </div>
            ...
            <div class="px-4 py-3 border-b border-slate-200 bg-[#f0f2f5] flex items-center justify-between gap-3">
              ...
              <div class="flex items-center gap-2">
                ...
                <button type="button" @click="toggleNotifications()"
                  class="h-9 w-9 rounded-full bg-white border border-slate-200 grid place-items-center hover:bg-slate-50"
                  :title="notifyEnabled ? 'Notificaciones activadas' : 'Activar notificaciones'">
                  <span x-text="notifyEnabled ? '🔔' : '🔕'"></span>
                </button>
            ...
            <form class="px-4 py-3 border-t border-slate-200 bg-[#f0f2f5]" @submit.prevent="send()">
              ...
              <div class="flex items-end gap-2">
                ...
                <button type="button" @click="toggleEmojiPicker()"
                  class="h-11 w-11 grid place-items-center rounded-full bg-white border border-slate-200 hover:bg-slate-50" title="Emoji">
                  😊
                </button>

                <!-- Attach -->
                <label class="h-11 w-11 grid place-items-center rounded-full bg-white border border-slate-200 cursor-pointer hover:bg-slate-50" title="Adjuntar">
                ...
                <button type="submit"
                  ...
                  :disabled="sending || (!isCreating && !ticket)" title="Enviar">
                  ➤
                </button>
              </div>
